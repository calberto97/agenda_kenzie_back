...
const createContactService = (payload, id) => __awaiter(void 0, void 0, void 0, function* () {
    const repo = data_source_1.AppDataSource.getRepository(contact_2.Contact);
    const contact = repo.create(Object.assign(Object.assign({}, payload), { client: id }));
    yield repo.save(contact);
